...
execute if score #domination.blue_progress game < #domination.red_progress game run function sco:process/domination/object/beacon/capture/capture_value/assist/blue
