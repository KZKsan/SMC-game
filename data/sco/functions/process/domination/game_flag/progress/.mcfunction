...
execute if score #domination.red_progress game < #domination.blue_progress game unless entity @e[type=item_display,tag=beacon.core,tag=!red,tag=!blue] run function sco:process/domination/game_flag/progress/assist/red
execute if score #domination.red_progress game > #domination.blue_progress game unless entity @e[type=item_display,tag=beacon.core,tag=!red,tag=!blue] run function sco:process/domination/game_flag/progress/assist/blue
