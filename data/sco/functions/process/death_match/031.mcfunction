...
execute if score #runtime game matches 5 run function sco:process/death_match/031/runtime_5
...
#プロセス終了
execute if score #runtime game matches 6 run function sco:process/death_match/game_flag/winner/