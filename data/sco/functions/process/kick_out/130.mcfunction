...
execute if score #runtime game matches 10 if score #score.kick_out.flag.scored game matches 1..4 run scoreboard players add #score.kick_out.flag.scored game 1
execute if score #runtime game matches 10 if score #score.kick_out.flag.scored game matches 5 run function sco:process/kick_out/game_flag/score/input
