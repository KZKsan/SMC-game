#>sco:player/team/team_info/team_score/set_display
#@api
scoreboard objectives modify team_info.blue displayname {"text": "得点","color": "yellow","bold": true}
scoreboard objectives modify team_info.red displayname {"text": "得点","color": "yellow","bold": true}
scoreboard objectives modify team_info.spectator displayname {"text": "得点","color": "yellow","bold": true}
