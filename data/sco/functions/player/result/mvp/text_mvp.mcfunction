...
tellraw @a [{"text": "Most kills: ","color": "white"},{"selector":"@a[tag=mvp_kill]","bold": true},{"text": " キル数： ","color": "white"},{"score": {"name": "@p[tag=mvp_kill]","objective": "score_kill_count"},"color": "gold"}]
...
tellraw @a [{"text": "Most damage inflicted: ","color": "white"},{"selector":"@a[tag=mvp_damage]","bold": true},{"text": " ダメージ量： ","color": "white"},{"score": {"name": "@p[tag=mvp_damage]","objective": "score_damage_dealt"},"color": "gold"}]
tellraw @a "----------------------------"
