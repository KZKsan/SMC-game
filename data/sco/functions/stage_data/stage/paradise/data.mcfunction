...
data modify storage sco:input penalty_area_new.penalty set value {1:[-245, -22, -118],2:[-385, -64, -56]}
data modify storage sco:input penalty_area_new.death set value {1:[-245, -17, -118],2:[-385, -64, -56]}
