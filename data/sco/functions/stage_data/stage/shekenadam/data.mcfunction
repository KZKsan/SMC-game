...
data modify storage sco:data stage set value "shekenadam"
data modify storage sco:data shop set value ""
data modify storage sco:data options set value {reset:1b}
data modify storage sco:data regine_area.stage set value {1:[-271, -7, -131],2:[-346, -49, -235]}
data modify storage sco:data stage_name set value '{"text":"シェケナダム"}'
