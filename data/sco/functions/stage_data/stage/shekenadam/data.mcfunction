...
data modify storage sco:input regine_area.stage set value {1:[-271, -7, -131],2:[-346, -49, -235]}
data modify storage sco:input penalty_area.input.death.stage set value {1:[-346, -7, -235],2:[-271, -49, -131]}
