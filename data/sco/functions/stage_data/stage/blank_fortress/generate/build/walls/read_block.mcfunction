...
execute if block ~ ~ ~ stone_brick_wall[east=none,west=none,north=none,south=none] if score #allow_tower0 _ matches 1 store result storage _ data_fetch.num int 1 run random value 0..2 sco:builder_seed
execute if block ~ ~ ~ stone_brick_wall[east=none,west=none,north=none,south=none] if score #allow_tower0 _ matches 0 store result storage _ data_fetch.num int 1 run random value 1..2 sco:builder_seed
