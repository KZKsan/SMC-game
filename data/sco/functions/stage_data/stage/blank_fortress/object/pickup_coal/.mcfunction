...
execute if entity @s[scores={stage_object.cooldown=1..}] run function sco:stage_data/stage/blank_fortress/object/pickup_coal/cooldown {name:"#blank_fortress.power_bullet.require_fuel"}