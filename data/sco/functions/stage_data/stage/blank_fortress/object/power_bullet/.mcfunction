...
execute if entity @s[scores={stage_object.count.0=170}] on passengers as @s[type=marker] if data entity @s data{team:"red"} if entity @p[team=red,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"red"}
execute if entity @s[scores={stage_object.count.0=170}] on passengers as @s[type=marker] if data entity @s data{team:"blue"} if entity @p[team=blue,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"blue"}
execute if entity @s[scores={stage_object.count.0=165}] on passengers as @s[type=marker] if data entity @s data{team:"red"} if entity @p[team=red,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"red"}
execute if entity @s[scores={stage_object.count.0=165}] on passengers as @s[type=marker] if data entity @s data{team:"blue"} if entity @p[team=blue,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"blue"}
execute if entity @s[scores={stage_object.count.0=160}] on passengers as @s[type=marker] if data entity @s data{team:"red"} if entity @p[team=red,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"red"}
execute if entity @s[scores={stage_object.count.0=160}] on passengers as @s[type=marker] if data entity @s data{team:"blue"} if entity @p[team=blue,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"blue"}
execute if entity @s[scores={stage_object.count.0=155}] on passengers as @s[type=marker] if data entity @s data{team:"red"} if entity @p[team=red,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"red"}
execute if entity @s[scores={stage_object.count.0=155}] on passengers as @s[type=marker] if data entity @s data{team:"blue"} if entity @p[team=blue,predicate=gamemode/as,x=-784, y=-63, z=-304,dx=159,dy=100,dz=79] positioned ~ ~4.5 ~ run function sco:stage_data/stage/blank_fortress/object/power_bullet_ammo/set {team:"blue"}
