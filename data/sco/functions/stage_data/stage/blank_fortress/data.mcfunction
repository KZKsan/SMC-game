...
data modify storage sco:input block_area.input append value {name:"stage",1:[-784, -47, -225],2:[-625, 9, -304]}
...
data modify storage sco:input penalty_area.input.death append value {name:"stage",1:[-784, -47, -225],2:[-625, 9, -304]}
data modify storage sco:input penalty_area.input.penalty append value {name:"stage",1:[-784, -47, -225],2:[-625, 0, -304]}
