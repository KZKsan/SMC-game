#>sco:stage_data/stage/random_tables/death_match
#@api
...
data modify storage sco:data random append value "jungle"
data modify storage sco:data random append value "centrifuge"
data modify storage sco:data random append value "deep_cave"