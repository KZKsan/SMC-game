...
#execute store success score # _ run data modify storage sco:data stage_tables.memory.evolution set from storage sco:data stage_tables.evolution
#execute if score # _ matches 1 if data storage sco:config game{rule:"evolution"} run data modify storage sco:data stage_tables.random set value [] 
