...
#ステージギミック
execute if score #runtime game matches ..59 run function sco:stage_data/stage_object/
execute if score #runtime game matches ..59 if data storage sco:data options{gimmick:true} run function sco:stage_data/gimmick

#ゲーム終了
execute if score #runtime game matches 60 run function sco:process/escalation/441/end