...
execute store result storage sco:data escalation.loot.blue_lvl int 1 run scoreboard players get #blue_score game
execute store result storage sco:data escalation.loot.red_lvl int 1 run scoreboard players get #red_score game
