...
#ステージギミック
execute if score #runtime game matches 3 run function sco:process/escalation/430/runtime_3
execute if score #runtime game matches 4.. run function sco:process/escalation/430/runtime_4__
execute if score #mst_time timer matches 010000 run function sco:messeges/1minutes

#プロセス終了
execute if score #runtime game matches 10 run function sco:process/escalation/430/runtime_10

#さどんです
execute if score #mst_time timer matches -110 run function sco:process/escalation/430/end