#>sco:process/escalation/432
#@within sco:main
#if (runtime >= 0) runtime++;
execute if score #runtime game matches ..9 run scoreboard players add #runtime game 1
#初期化
execute if score #runtime game matches 1 run function sco:process/escalation/432/runtime_1

execute if score #runtime game matches 5 run function sco:process/escalation/432/runtime_5
...
#ステージギミック
execute if score #runtime game matches 3 run function sco:process/escalation/432/runtime_3
execute if score #runtime game matches 4.. run function sco:process/escalation/432/runtime_4__
execute if score #mst_time timer matches 010000 run function sco:messeges/1minutes

#プロセス終了
execute if score #runtime game matches 10 run function sco:process/escalation/432/runtime_10

#さどんです
execute if score #mst_time timer matches -110 run function sco:process/escalation/432/end