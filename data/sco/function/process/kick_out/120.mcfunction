...
execute if score #runtime game matches 1 run function sco:process/kick_out/120/runtime_1
execute if score #runtime game matches 1.. run function sco:process/kick_out/120/runtime_1__
...
#end
execute if score #mst_time timer matches -110 run function sco:process/kick_out/120/end