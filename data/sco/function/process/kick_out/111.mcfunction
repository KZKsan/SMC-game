...
execute if score #runtime game matches 1 run function sco:process/kick_out/111/runtime_1
execute if score #runtime game matches 5 run function sco:process/kick_out/111/runtime_5
...
#ステージギミック
execute if score #runtime game matches 3 run function sco:process/kick_out/111/runtime_3
execute if score #runtime game matches 4.. run function sco:process/kick_out/111/runtime_4__

#end
execute if score #mst_time timer matches -110 run function sco:process/kick_out/111/end
