#>sco:process/domination/object/beacon/assist_activator/disable/blue
...
execute if score #domination.progress_difference game <= #domination.assist_threshold game run scoreboard players set #domination.assist_flag game 0
