#>sco:process/domination/211
#@within sco:main
execute if score #runtime game matches ..5 run scoreboard players add #runtime game 1
execute if score #runtime game matches 1 run function sco:process/domination/211/runtime_1
execute if score #runtime game matches 5 run function sco:process/domination/211/runtime_5
#切断処理
...
#ステージギミック
execute if score #runtime game matches 3 run function sco:process/domination/211/runtime_3
execute if score #runtime game matches 4.. run function sco:process/domination/211/runtime_4

#プロセス終了
execute if score #mst_time timer matches -110 run function sco:process/domination/211/end