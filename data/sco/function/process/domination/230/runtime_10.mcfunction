...
execute as @a[predicate=sco:team_join,team=!spectator,scores={respawn.wait_time=1..},tag=rg.penalty_respawn] at @s run function sco:process/domination/respawn/wait_timefunction sco:process/domination/game_flag/progress/
