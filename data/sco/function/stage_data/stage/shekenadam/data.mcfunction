...
data modify storage sco:input respawn append value {name:"stage_red",pos:"-319 -41 -226 0 0"}
data modify storage sco:input respawn append value {name:"stage_blue",pos:"-330 -41 -141 -150 0"}
