#>sco:stage_data/stage/blank_fortress/object/power_bullet/click/launch
...
scoreboard players set @s stage_object.count.0 1
scoreboard players set @s stage_object.count.1 0
scoreboard players operation @s stage_object.cooldown = #blank_fortress.power_bullet.cooltime stage_object.configs
