...
execute as @e[type=interaction, tag=blank_fortress, tag=shield] at @s run function sco:stage_data/stage/blank_fortress/object/shield/
execute as @e[type=interaction, tag=blank_fortress, tag=boost] at @s run function sco:stage_data/stage/blank_fortress/object/boost/
