...
tag @s add origin
execute if score # _ matches 0 if entity @s[team=red] at @r[predicate=gamemode/as,limit=1,team=blue,distance=..20] summon lightning_bolt run function sco_items:item_functions/lightning_hammer/particle
execute if score # _ matches 0 if entity @s[team=blue] at @r[predicate=gamemode/as,limit=1,team=red,distance=..20] summon lightning_bolt run function sco_items:item_functions/lightning_hammer/particle
