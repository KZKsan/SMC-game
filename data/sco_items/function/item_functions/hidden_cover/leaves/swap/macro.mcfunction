...
$execute unless entity @p[nbt={UUID:$(Owner)},distance=..1.7] positioned as @p[nbt={UUID:$(Owner)},tag=hidden_cover.run,gamemode=!spectator] align xyz run teleport @s ~0.5 ~ ~0.5
