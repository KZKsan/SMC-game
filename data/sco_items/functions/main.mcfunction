...
# arrow
    ...
    execute as @e[type=#arrows,nbt={item:{tag:{Enchantments:[{id:"minecraft:piercing"}]}}},tag=!item_function.piercing_arrow] run function sco_items:item_functions/enchant/piercing/set_nbt
# magic_bullet
