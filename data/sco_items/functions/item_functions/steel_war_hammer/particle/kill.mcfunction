#>sco_items:item_functions/steel_war_hammer/particle/kill
#@within sco_items:item_functions/steel_war_hammer/kill
...
particle block redstone_block ~ ~1 ~ 0.1 0.3 0.1 1 150 normal
