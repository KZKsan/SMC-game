#>sco_items:item_functions/throw_lock/actionbar/
#@within sco_items:actionbar/
scoreboard players set #6 _ 6
scoreboard players operation #time _ = @s throw_lock.max_time
scoreboard players operation #time _ -= @s throw_lock.time
