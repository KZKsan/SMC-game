...
scoreboard players add @s[tag=!rg_item_function_limit,scores={lightning_hammer_holding_time=0..}] lightning_hammer_holding_time 1
execute if entity @s[tag=!rg_item_function_limit,scores={lightning_hammer_holding_time=60..}] run function sco_items:item_functions/lightning_hammer/summon_lightning
