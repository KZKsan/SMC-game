...
execute anchored eyes rotated ~ 0 positioned ^ ^-0.4 ^ rotated as @s run particle block cyan_stained_glass ^ ^ ^1 0 0 0 0.3 5 normal
execute anchored eyes rotated ~ 0 positioned ^ ^-0.4 ^ rotated as @s run particle block ice ^ ^ ^1 0.1 0.3 0.1 0.1 10 normal
