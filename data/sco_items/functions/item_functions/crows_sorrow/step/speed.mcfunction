...
attribute @s generic.knockback_resistance modifier add 1000-20-0-0-1 "crows_sorrow.knockback_resistance" 10 add_multiplied_base
attribute @s generic.jump_strength modifier add 1000-20-0-0-1 "crows_sorrow.jump_strength" -1000 add_multiplied_base
