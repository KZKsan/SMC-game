...
attribute @s generic.attack_damage modifier add 1000-20-0-0-1 "crows_sorrow_attack_damage" 13 add
attribute @s generic.attack_speed modifier add 1000-20-0-0-1 "crows_sorrow_haste" 100 add