...
execute unless entity @s[team=] as @e[tag=hurt_entity,distance=..17,nbt={HurtTime:10s}] at @s if function sco_items:item_functions/dimensional_sword/team run function sco_items:item_functions/dimensional_sword/particle
