...
particle block{block_state:"obsidian"} ~ ~1 ~ 0.1 1 0.1 0.1 20
particle item{item:"ender_eye"} ~ ~1 ~ 0.1 0.3 0.1 0.1 5
particle block{block_state:"black_stained_glass"} ~ ~1 ~ 0.1 1 0.1 0.2 10
