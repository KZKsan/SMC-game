#>sco_items:item_functions/corpse_daemon/actionbar/
#@within 
function sco_items:actionbar/set_str
scoreboard players set #6 _ 6
scoreboard players operation #time _ = #corpse_daemon.set_cooltime sco_items.configs
scoreboard players operation #time _ -= @s corpse_daemon.cooldown
