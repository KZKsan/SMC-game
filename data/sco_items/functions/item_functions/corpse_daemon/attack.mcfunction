...
effect give @s[tag=!rg.item_function_limit] blindness 8 0
effect give @s[tag=!rg.item_function_limit] mining_fatigue 8 9
effect give @s[tag=!rg.item_function_limit] slowness 8 1
