...
execute anchored eyes positioned ^ ^-0.5 ^0.5 as @e[type=#arrows,distance=..2,tag=!item_function.netherite_plating_shield.arrow_hit] run function sco_items:item_functions/netherite_plating_shield/arrows
