...
execute store result storage _ Pos[0] double 0.0001 run scoreboard players get @s blast_motion_return.0
execute store result storage _ Pos[1] double 0.0001 run scoreboard players get @s blast_motion_return.1
execute store result storage _ Pos[2] double 0.0001 run scoreboard players get @s blast_motion_return.2
