...
execute store result storage _ Pos[0] double 0.0001 run scoreboard players get @s blast_motion_pos.0
execute store result storage _ Pos[1] double 0.0001 run scoreboard players get @s blast_motion_pos.1
execute store result storage _ Pos[2] double 0.0001 run scoreboard players get @s blast_motion_pos.2
