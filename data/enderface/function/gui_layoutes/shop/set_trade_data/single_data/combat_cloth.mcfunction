#>enderface:gui_layoutes/shop/set_trade_data/single_data/combat_cloth
#@within enderface:gui_layoutes/shop/set_trade_data/category/**

#@private
#declare loot_table sco_items:combat_cloth
#declare loot_table sco_items:shield
loot replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 loot sco_items:combat_cloth
