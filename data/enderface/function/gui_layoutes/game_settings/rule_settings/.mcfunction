...
loot replace entity @s enderchest.11 loot enderface:sco_settings/rule/kick_out
...
execute if data storage sco:config game{rule:"kick_out"} run item modify entity @s enderchest.11 enderface:selected
