...
loot replace entity @s enderchest.13 loot enderface:sco_settings/rule/death_match
loot replace entity @s enderchest.14 loot enderface:sco_settings/rule/domination
...
execute if data storage sco:config game{rule:"death_match"} run item modify entity @s enderchest.13 enderface:selected
execute if data storage sco:config game{rule:"domination"} run item modify entity @s enderchest.14 enderface:selected
