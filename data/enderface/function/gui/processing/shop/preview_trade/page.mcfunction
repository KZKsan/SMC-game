...
data modify storage enderface:data shop.preview_trade_data.table set from storage p-storage _[0].data.enderface.shop.preview_trade.table
$data modify storage enderface:data shop.preview_trade_data.data set from storage enderface:data shop.preview_trade_data.table[$(preview_trade_page)]
