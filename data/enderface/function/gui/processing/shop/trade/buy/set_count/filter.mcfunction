...
execute if data storage enderface:data shop{data_changed:0b} unless data storage enderface:data test_item.components if data storage enderface:data shop.tmp.buy[0].components run return fail
execute if data storage enderface:data shop{data_changed:0b} if data storage enderface:data test_item.components unless data storage enderface:data shop.tmp.buy[0].components run return fail
