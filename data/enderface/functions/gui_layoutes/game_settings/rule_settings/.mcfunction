...
loot replace entity @s enderchest.12 loot enderface:sco_settings/rule/death_match
loot replace entity @s enderchest.14 loot enderface:sco_settings/rule/kick_out
