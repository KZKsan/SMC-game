...
item replace entity @s enderchest.12 with iron_sword{enderfaceItem:1b,display:{Name:'{"text": "デスマッチ","italic": false,"color": "red"}'},HideFlags:32}
item replace entity @s enderchest.14 with golden_axe{enderfaceItem:1b,display:{Name:'{"text": "キックアウト","italic": false,"color": "yellow"}'},HideFlags:32}
