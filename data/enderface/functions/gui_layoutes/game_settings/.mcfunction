...
execute if data storage sco:config game{can_team_select:false} run item replace entity @s enderchest.13 with gray_dye{enderfaceItem:1b,display:{Name:'{"text": ">チーム選択","italic": false}',Lore:['{"text": "|OFF|","color": "gray","italic": false}']},click_events:{click_sounds:[{sound:"ui.button.click"}]}}
execute if data storage sco:config game{can_team_select:true} run item replace entity @s enderchest.13 with lime_dye{enderfaceItem:1b,display:{Name:'{"text": ">チーム選択","italic": false}',Lore:['{"text": "|ON|","color": "green","italic": false}']},click_events:{click_sounds:[{sound:"ui.button.click"}]}}
