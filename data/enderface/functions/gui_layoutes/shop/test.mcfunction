...
#エメラルド x2 && 鉄インゴット x2
item replace entity @s enderchest.0 with coal{trade:{buy:[{id:"minecraft:emerald",Count:2b},{id:"minecraft:iron_ingot",Count:2b}],sell:[{id:"minecraft:coal",Count:5b}],sell_count:{click:1b,sneak:6b}},enderfaceItem:1b} 10
