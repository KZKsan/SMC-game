...
execute if data entity @e[predicate=marker_storage,limit=1] data.preview_trade.buy[4] run function enderface:gui_layoutes/shop/preview_trade/buy_items/0-5
execute if data entity @e[predicate=marker_storage,limit=1] data.preview_trade.buy[2] if score # _ matches 0 run function enderface:gui_layoutes/shop/preview_trade/buy_items/0-3
