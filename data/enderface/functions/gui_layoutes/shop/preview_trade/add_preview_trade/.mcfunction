...
execute store result score #line _ run data get storage p-storage _[0].data.preview_trade.add_preview_trade
...
execute unless data storage p-storage _[0].data.preview_trade{page:0} run function enderface:gui_layoutes/shop/preview_trade/add_preview_trade/up_arrow
