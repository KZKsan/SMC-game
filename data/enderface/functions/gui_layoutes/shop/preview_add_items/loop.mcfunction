...
data modify entity @e[tag=gui_layout_item,distance=..2,limit=1] Items append from storage _ _[0]
data remove storage _ _[0]
scoreboard players add #i _ 1
execute if data storage _ _[0] run function enderface:gui_layoutes/shop/preview_add_items/loop