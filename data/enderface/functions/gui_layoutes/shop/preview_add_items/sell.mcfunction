#>enderface:gui_layoutes/shop/preview_add_items/sell
...
data modify storage enderface:shop preview_trade.add_sell_items set from storage p-storage _[0].data.preview_trade.trade.components."minecraft:custom_data".trade.sell
