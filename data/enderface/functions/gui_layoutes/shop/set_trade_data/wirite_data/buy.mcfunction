...
data modify storage enderface:shop _.components."minecraft:custom_data".preview_trade[-1].buy append from entity @e[tag=set_trade_data,limit=1,distance=..2] Items[]
data remove storage enderface:shop _.components."minecraft:custom_data".preview_trade[-1].buy[].Slot
