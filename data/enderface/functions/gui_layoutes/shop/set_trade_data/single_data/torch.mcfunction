#>enderface:gui_layoutes/shop/set_trade_data/single_data/torch
#@within enderface:gui_layoutes/shop/set_trade_data/category/**

#>
#@private
#declare loot_table sco_items:torch
loot replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 loot sco_items:torch
function enderface:gui_layoutes/shop/set_trade_data/wirite_data/icon/preview
function enderface:gui_layoutes/shop/set_trade_data/wirite_data/sell
item replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 with iron_boots 1
