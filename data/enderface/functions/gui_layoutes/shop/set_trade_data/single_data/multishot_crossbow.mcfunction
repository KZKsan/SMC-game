#>enderface:gui_layoutes/shop/set_trade_data/single_data/multishot_crossbow
#@within enderface:gui_layoutes/shop/set_trade_data/category/**

#>
#@private
#declare loot_table sco_items:multishot_crossbow
loot replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 loot sco_items:multishot_crossbow
