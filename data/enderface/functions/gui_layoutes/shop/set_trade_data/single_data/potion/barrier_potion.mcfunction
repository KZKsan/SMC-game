...
#>
#@private
#declare loot_table sco_items:potion/barrier_potion
loot replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 loot sco_items:potion/barrier_potion
