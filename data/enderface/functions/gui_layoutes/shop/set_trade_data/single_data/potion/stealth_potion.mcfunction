#>enderface:gui_layoutes/shop/set_trade_data/single_data/potion/stealth_potion
#@within enderface:gui_layoutes/shop/set_trade_data/category/potions

#>
#@private
#declare loot_table sco_items:potion/stealth_potion
loot replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 loot sco_items:potion/stealth_potion
