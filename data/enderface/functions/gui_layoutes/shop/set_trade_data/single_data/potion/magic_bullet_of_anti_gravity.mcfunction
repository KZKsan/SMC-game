...
item replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.1 with blaze_rod{display:{Name:'[{"text":"Enemy","color":"green","bold":true,"italic":false},{"text":" Killer","color":"red","bold":true,"italic":false}]'},Enchantments:[{id:"minecraft:sharpness",lvl:9999s}]} 64
