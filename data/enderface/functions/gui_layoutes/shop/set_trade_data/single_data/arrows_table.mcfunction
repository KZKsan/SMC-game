...
# healing_arrow
#declare loot_table sco_items:arrow/healing_arrow
loot replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.0 loot sco_items:arrow/healing_arrow
