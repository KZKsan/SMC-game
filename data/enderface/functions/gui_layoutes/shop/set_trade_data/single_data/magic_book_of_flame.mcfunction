...
#declare loot_table sco_items:magic_book
...
item replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.1 with iron_helmet
item replace entity @e[tag=set_trade_data,limit=1,distance=..2] container.2 with iron_chestplate
