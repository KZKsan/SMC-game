...
execute if data storage p-storage _[0].data.save_kit[{number:2}] run data modify storage enderface:data data set from storage p-storage _[0].data.save_kit.[{number:2}].inventory
