...
execute if data storage p-storage _[0].data.save_kit[{number:3}] run data modify storage enderface:data kit_memory.data set from storage p-storage _[0].data.save_kit.[{number:3}].inventory
