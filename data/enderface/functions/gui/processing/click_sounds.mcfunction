...
execute if data storage enderface:data gui_intaract.Item.tag.click_events{click_sounds:[{sound:"ui.button.bell"}]} run playsound entity.experience_orb.pickup record @s ~ ~ ~ 0.5 2
