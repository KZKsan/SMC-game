...
tag @s[team=!mode.waiting] remove mode.waiting
execute if data storage enderface:data gui_intaract{click:1b,Item:{Slot:15b}} run function enderface:gui/processing/join_the_game/practice
